...
config.trader = {
  ...
  currencyAmountAvailableToTrade = false, // set to a number to limit the amount of fiat currency available to Gekko to trade at initiation. Set to false to disable.
}
